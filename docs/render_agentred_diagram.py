...
arrow_poly([(1175, 455), (1215, 455), (1215, 378), (1265, 378)], orange, 2)
arrow_poly([(1175, 455), (1265, 496)], orange, 2)
arrow_poly([(1175, 455), (1215, 455), (1215, 614), (1265, 614)], orange, 2)
...
card(1265, 340, 230, 95, 'Mapper batch-001', ['skills, tools, pain points'], orange, C('#7c2d12', 140), 'isolated context')
card(1265, 458, 230, 95, 'Mapper batch-002', ['budget and automation signals'], orange, C('#7c2d12', 140), 'wave controlled')
card(1265, 576, 230, 95, 'Mapper batch-N', ['DemandSignal JSON'], orange, C('#7c2d12', 140), 'parse and repair')
card(1600, 315, 230, 110, 'Reducer', ['aggregate and cluster', 'resolve contradictions', 'rank opportunity themes'], violet, C('#4c1d95', 140))
